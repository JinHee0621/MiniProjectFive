   ...
   public void update() {
      ...
      for(int i = 0; i < 5; i++) {
         if((KeyManager.Instance().onceMouseClicked(MouseEvent.BUTTON1))&&((pointerInfo.getLocation().x >= 217 && pointerInfo.getLocation().x <= 1625) && (pointerInfo.getLocation().y >= 32 &&pointerInfo.getLocation().y <= 922))){
            ...
            switch(cnt) {
            case 1 : bg.changeImage("images\\titleImages\\start2.png");   break;
            case 2 : bg.changeImage("images\\titleImages\\start3.png");   break;
            case 3 : bg.changeImage("images\\titleImages\\start4.png");   break;
            case 4 : bg.changeImage("images\\titleImages\\start5.png");   break;
            default : cnt--;            
            }
